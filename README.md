# @thomas/sails-generate-vue-component
...
```sh
$ npm install @thomas/sails-generate-vue-component --save
```
...
{
  "modules": {
    "vue-component": "@thomas/sails-generate-vue-component"
  }
}
```

> Note that instead of `"@thomas/sails-generate-vue-component"`, you can also choose to provide the path to the generator locally (e.g. "./generators/vue-component").
...
## Bugs &nbsp; [![NPM version](https://badge.fury.io/js/@thomas/sails-generate-vue-component.svg)](http://npmjs.com/package/@thomas/sails-generate-vue-component)
...
[![NPM](https://nodei.co/npm/@thomas/sails-generate-vue-component.png?downloads=true)](http://npmjs.com/package/@thomas/sails-generate-vue-component)
